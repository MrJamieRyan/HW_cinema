...
class Screening
  ...
  attr_reader :id
  attr_accessor :film_id, :date, :time, :limit
  ...
  def save
    sql = "INSERT INTO screenings (film_id, date, time, limit)
          VALUES ($1, $2, $3, $4) RETURNING id"
    values = [@film_id, @date, @time, @limit]
  ...
  def update
    sql = "UPDATE screenings SET (film_id, date, time, limit) = ($1, $2, $3, $4) WHERE id = $4"
    values = [@film_id, @date, @time, @limit, @id]
